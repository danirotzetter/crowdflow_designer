/*
* By https://github.com/frapontillo/angular-bootstrap-switch
* Customized by Dani Rotzetter
 */

'use strict';

app
  .directive('bsSwitch', function ($timeout, Tools) {
    return {
      template:
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var listenToModel = function() {
		  ...
		  /*
		  * Removed due to incompatibility with existing library
        ...
        var listenToView = function() {
          ...
          element.on('switch-change', function (e, data) {
            var value = data.value;
              ...
              if(scope.switchClick)
              scope.switchClick();
              // Otherwize, change the value
              else
            scope.ngModel = value;

			// Instruct AngularJS to refresh
			Tools.refresh();
          });
        };
